...
export default class ManageClient extends React.Component {
  ...
  // loadData url: 'http://mycompetitionprojectprofile.azurewebsites.net/profile/profile/getClientList',
  //deleteClient  url: 'http://mycompetitionprojectprofile.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
