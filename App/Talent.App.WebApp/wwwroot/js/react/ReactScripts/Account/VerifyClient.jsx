...
export default class VerifyClient extends React.Component {
  ...
  queryString() {
    let { recruiterEmail, clientEmail, resetPasswordToken } =
  ...
  checkToken(recruiterEmail, clientEmail, resetPasswordToken) {
    ...
    let url = `http://mycompetitionprojectidentity.azurewebsites.net/authentication/authentication/verifyClientToken?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
    $.ajax({
      url: url,
      type: "POST",
  ...
  savePassword() {
    let { newPassword, recruiterEmail, clientEmail, resetPasswordToken } =
      this.state;

    let resetUrl = `http://mycompetitionprojectidentity.azurewebsites.net8/authentication/authentication/validateInvitation?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
